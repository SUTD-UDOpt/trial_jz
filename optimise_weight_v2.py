...
header = {
    "RhinoComputeKey": '0hOfevzxs49OfbXDqyUx'
}
...
for i, row in ndf.iterrows():
    # run compute to save dracomeshes for selected solutions: saves 1) base mesh and 2) buildings mesh
    filename = 'static\gh\module B_showcase.ghx'
